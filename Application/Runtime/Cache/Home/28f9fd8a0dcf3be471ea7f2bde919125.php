...
<div class="content">
    ...
    <div id="right">
        <table class="goods_view_table goods_table" style="width: 100%" border="1" cellpadding="0" cellspacing="0">
            <tr>
                <th>收银员名</th><th>联系电话</th><th>操作</th>
            </tr>
            <?php if(is_array($users)): foreach($users as $key=>$value): ?><tr>
                ...
                <td align="center"><a href="/index.php/Home/Admin/edituser/uid/<?php echo ($value["uid"]); ?>">编辑</a> | <a href="/index.php/Home/Admin/deluser/uid/<?php echo ($value["uid"]); ?>">删除</a></td>
