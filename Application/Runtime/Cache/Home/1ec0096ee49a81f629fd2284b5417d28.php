...
<div class="content">
    ...
    <div id="right">
        <table class="goods_view_table goods_table" style="width: 100%" border="1" cellpadding="0" cellspacing="0">
            <tr>
                <th>门店名称</th><th>门店编号</th><th>操作</th>
            </tr>
            <?php if(is_array($shops)): foreach($shops as $key=>$value): ?><tr>
                <td align="center"><?php echo ($value["shop_name"]); ?></td>
                <td align="center"><?php echo ($value["shop_num"]); ?></td>
                <td align="center"><a href="/index.php/Home/Admin/editshops/sid/<?php echo ($value["id"]); ?>">编辑</a> | <a href="/index.php/Home/Admin/delshops/sid/<?php echo ($value["id"]); ?>">删除</a></td>
