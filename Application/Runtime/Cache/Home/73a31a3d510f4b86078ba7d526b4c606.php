...
<div class="content">
    ...
    <div id="right">
        <form name="form" method="post" action="/index.php/Home/admin/editgoods" onsubmit="return checkform()">
        <table class="goods_table">
            <input type="hidden" name="gid" value="<?php echo ($goods["gid"]); ?>">
            <tr><td>商品编号：</td><td><input type="text" name="goods_number" value="<?php echo ($goods["goods_number"]); ?>" required="required"></td></tr>
            <tr><td>商品名称：</td><td><input type="text" name="goods_name" value="<?php echo ($goods["goods_name"]); ?>" required="required"></td></tr>
            <tr><td>商品价格：</td><td><input type="text" name="goods_money" value="<?php echo ($goods["goods_money"]); ?>" required="required"></td></tr>
            <tr><td>商品积分：</td><td><input type="text" name="goods_int" value="<?php echo ($goods["goods_int"]); ?>" required="required"></td></tr>
            <tr><td>商品库存：</td><td><input type="text" name="goods_stock" value="<?php echo ($goods["goods_stock"]); ?>" required="required"></td></tr>
