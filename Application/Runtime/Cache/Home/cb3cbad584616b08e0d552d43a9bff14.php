...
<head>
    ...
    <script>
        function checkform(){
            var name = document.form.user_name;
            var tel = document.form.tel;

            if(!checkinput(name, 'req', '请输入收银员名！')){
                return false;
            }
            if(!checkinput(tel, 'req', '请输入联系电话！')){
                return false;
            }
        }
    </script>
...
<div class="content">
    ...
    <div id="right">
        <form name="form" method="post" action="/index.php/Home/admin/edituser" onsubmit="return checkform()">
        <table class="goods_table">
            <input type="hidden" name="uid" value="<?php echo ($user["uid"]); ?>">
            <tr><td>收银员名：</td><td><input type="text" name="user_name" value="<?php echo ($user["user_name"]); ?>" required="required"></td></tr>
            <tr><td>登陆密码：</td><td><input type="text" name="password"></td></tr>
            <tr><td>联系电话：</td><td><input type="text" name="tel" value="<?php echo ($user["tel"]); ?>" required="required"></td></tr>
